...
resource "aws_s3_bucket" "cloudfront_logs" {
  bucket = var.environment == "sandbox" ? "${replace(var.domain_name, "-ustc-website-cloudfront-logs", "")}-ustc-website-cloudfront-logs": "${var.environment}-ustc-website-cloudfront-logs"
}

        ...
        new_page = home_page.add_child(
            instance=EnhancedStandardPage(
                ...
                body=[
                    ...
                    {
                        "type": "paragraph",
                        "value": f"""The Court's Rules of Practice and Procedure governing admission and discipline can be found in Title XX, Practice Before the Court:<ul>
                        <li><a href="{practitioners_docs["Rule-200(2nd-amended).pdf"].file.url}">Rule 200. Admission to Practice and Periodic Registration Fee</a></li>
                        <li><a href="{practitioners_docs["Rule-201.pdf"].file.url}">Rule 201. Conduct of Practice Before the Court</a></li>
                        <li><a href="{practitioners_docs["Rule-202.pdf"].file.url}">Rule 202. Disciplinary Matters</a></li>
                        </ul>""",
                    },
                    {"type": "hr", "value": True},
                    ...
                    {
                        "type": "paragraph",
                        "value": f"""On May 2, 2020, the Court announced that attorney applications for admission to practice before the Court may be emailed to the <a href="mailto:Admissions@ustaxcourt.gov" title="Admissions@ustaxcourt.gov">Admissions Office</a> and must include:
                        <ul>
                            <li><a href="{practitioners_docs["Application_for_Admission_to_Practice_Attorney_Form_30.pdf"].file.url}">Application for Admission to Practice, Form 30</a>. For instructions on completing the form, please see <a href="{practitioners_docs["Admissions_Information_Attorney_12212021.pdf"].file.url}">Admissions Information for Attorneys</a>.</li>
                            <li>Proof of payment of the $50 Application Fee (pay via <a href="https://pay.gov">Pay.gov</a>).</li>
                    ...
                    {
                        "type": "paragraph",
                        "value": f"""A nonattorney may be admitted to practice before the Court provided the requirements outlined in the Tax Court Rules of Practice and Procedure are satisfied. See <a href="{practitioners_docs["Rule-200(2nd-amended).pdf"]}">Rule 200</a>, Tax Court Rules of Practice and Procedure.
                        <br/><br/>
                        <strong>Resources:</strong>
                        <ul>
                            <li><a href="{practitioners_docs["05082023.pdf"].file.url}">Press Release announcing the 2023 Nonattorney Examination</a></li>
                            <li><a href="{practitioners_docs["NonAttorney_Exam_Statistics.pdf"].file.url}">Statistical Information Regarding the Nonattorney Examination</a></li>
                            <li><a href="{practitioners_docs["Nonattorney_Examination_Procedures_050322.pdf"].file.url}">Procedures for the Preparation and Grading of the Nonattorney Examination</a></li>
                            <li>Downloadable copies of the last three examinations can be found below. To order paper copies, please submit a request via <a href="pay.gov">Pay.gov</a>.</li>
                            <ul>
                                <li><a href="{practitioners_docs["2018_Nonattorney_Exam.pdf"].file.url}">Prior Year Exam 2018</a></li>
                                <li><a href="{practitioners_docs["2021_Nonattorney_Exam.pdf"].file.url}">Prior Year Exam 2021</a></li>
                                <li><a href="{practitioners_docs["2023_Nonattorney_Exam.pdf"].file.url}">Prior Year Exam 2023</a></li>
                            </ul>
                        </ul>
                        <strong>Character and Fitness:</strong><br/><br/>
                        An applicant must establish to the satisfaction of the Court that he or she is of good moral and professional character, including by providing sponsorship letters. See <a href="{practitioners_docs["Rule-200(2nd-amended).pdf"].file.url}">Rule 200</a>, Tax Court <a href="/rules">Rules of Practice and Procedure</a>. Accordingly, after administration of the Nonattorney Exam, those who pass will be required to undergo a character and fitness review. The review will include requests for additional background information, sponsorship letters, and a remote interview. Any necessary documentation will be requested at that time.""",
                    },
                    {"type": "hr", "value": True},
                    {"type": "h3", "value": "Certificates of Good Standing"},
                    {
                        ...
                        <ul>
                            <li>To request an electronic certificate of good standing free of charge, email your request to the <a href="mailto:Admissions@ustaxcourt.gov" title="Admissions@ustaxcourt.gov">Admissions Office</a> with your name and US Tax Court bar number.</li>
                            <li>To request a paper certificate of good standing with the Court’s raised seal, submit $15 payment via <a href="pay.gov">Pay.gov</a> and it will be mailed directly to you.</li>
                        </ul>""",
                    },
                    {"type": "hr", "value": True},
                    ...
                    {
                        "type": "paragraph",
                        "value": """For additional disciplinary action, refer to previous <a href="/press_releases">Press Releases</a>.""",
                    },
                    {"type": "hr", "value": True},
                    {"type": "h2", "value": "Limited Entries of Appearance"},
                    {
                        "type": "paragraph",
                        "value": f"""On May 29, 2020, the Court issued <a href="{practitioners_docs["Administrative_Order_2020-03.pdf"].file.url}">Administrative Order 2020-03</a> which outlines the procedures for entering a limited entry of appearance. These procedures are effective June 1, 2020.""",
                    },
                    {
                        "type": "links",
                        "value": {

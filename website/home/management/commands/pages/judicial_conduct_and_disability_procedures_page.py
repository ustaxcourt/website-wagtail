...
class JudicialConductAndDisabilityProceduresPageInitializer(PageInitializer):
    ...
    def create_page_info(self, home_page):
        ...
        body_text = (
            ...
            f"""<p>Below are Links to the Procedures that establish what may be complained about, who may be complained about, where to file a complaint, and how the complaint will be processed. You may view the <strong><a href="{jcdp_docs["jcd_rules.pdf"]}" target="_blank" title="Tax Court Judicial Conduct and Judicial Disability Procedures">Tax Court Judicial Conduct and Judicial Disability Procedures</a></strong>, a <strong><a href="{jcdp_docs["jcd_users_guide.pdf"]}" target="_blank" title="User’s Guide to the Judicial Conduct and Judicial Disability Procedures">User’s Guide to the Judicial Conduct and Judicial Disability Procedures</a></strong>, and <strong><a>Orders issued in Judicial Conduct and Disability Cases in the Tax Court</a></strong>. You must submit any complaints on the <strong><a href="{jcdp_docs["jcd_complaint_form.pdf"]}" target="_blank" title="Complaint form">complaint form</a></strong>. You may complete the form online, print it, and mail it to the address indicated in both the Procedures and the Users’ Guide. The form may not be submitted electronically.</p>"""
        )

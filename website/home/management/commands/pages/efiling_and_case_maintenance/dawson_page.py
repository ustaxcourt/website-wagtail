...
class DawsonPageInitializer(PageInitializer):
    ...
    def create_page_info(self, home_page):
        ...
        dawson_fancy_card = FancyCard(
            ...
            text="A document filed through DAWSON is timely if it is electronically filed by <strong>11:59 p.m., Eastern time,</strong> on the day it is due.<p>DAWSON has been designed to work with most modern browsers (Chrome, Firefox, Safari, Edge, etc.). Internet Explorer is not supported by this system.</p>",
            parent_page=dawson_page,
        )

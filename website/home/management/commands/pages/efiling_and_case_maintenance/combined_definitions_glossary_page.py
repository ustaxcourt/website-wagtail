...
class CombinedDefinitionsGlossaryPageInitializer(PageInitializer):
    def __init__(self):
        super().__init__()
    ...
    def create_page_info(self, home_page):
        ...
        # Combine all definitions from definitions page and glossary page
        # All entries will be in alphabetical order
        all_questions = [
            # From original Definitions page
            {
                "question": "Designated Service Person",
                "answer": f'"Designated Service Person" means the practitioner designated to receive service of documents in a case. The first counsel of record is generally the Designated Service Person, see <a linktype="document" id="{definition_docs["rule-21.pdf"].id}"><b>Rule 21(b)(2)</b></a>. The ability to designate an additional service person in DAWSON is coming soon.',
                "anchortag": "DESIGNATED_SERVICE_PERSON",
            },
            {
                "question": "Document",
                "answer": '"Document" means any written matter filed by or with the Court including, but not limited to motions, pleadings, applications, petitions, notices, declarations, affidavits, exhibits, briefs, memoranda of law, orders, and deposition transcripts.',
                "anchortag": "DOCUMENT",
            },
            {
                "question": "eLodged",
                "answer": '"eLodged" refers to any document that is electronically submitted to the Court with a motion for leave through DAWSON and that is not automatically filed.',
                "anchortag": "ELODGED",
            },
            {
                "question": "Intervenor / Participant",
                "answer": f'"Intervenor" is a third party who has an interest in the outcome of the case. The most common example is the spouse or former spouse of a petitioner seeking innocent spouse relief. "Participant" is a partner who elects to participate in a partnership action by filing a notice of election to participate under <a linktype="document" id="{definition_docs["rule-245.pdf"].id}"><b>Rule 245</b></a>.',
                "anchortag": "INTERVENOR",
            },
            {
                "question": "Party",
                "answer": '"Party", for purposes of electronic access, means either petitioner(s) or respondent (IRS).',
                "anchortag": "PARTY",
            },
            {
                "question": "PDF",
                "answer": '"PDF" means Portable Document Format. Documents in PDF may be opened in Adobe Reader or an equivalent viewer. Adobe Reader may be downloaded free of charge from the Adobe website (www.adobe.com). Electronic documents may be converted to PDF through a word processor, third party PDF creation software such as Adobe Acrobat, or online PDF creation services from Adobe (<a href="https://createpdf.adobe.com/">https://createpdf.adobe.com/</a>) and others. Documents in paper form may be scanned into PDF.',
                "anchortag": "PDF",
            },
            {
                "question": "Pro Se",
                "answer": '"Pro Se" means a petitioner who represents themselves without a lawyer or an entity appearing through an authorized fiduciary or officer.',
                "anchortag": "PRO_SE",
            },
            # From Petitioners Glossary page
            {
                "question": "Abatement",
            ...
            {
                "question": "At issue",
                "answer": f'A case is deemed "at issue" once the petition and answer have been filed. In some very limited circumstances where a reply is required, the case will be at issue after a reply to the answer is filed. See <strong><a linktype="document" id="{definition_docs["rule-37.pdf"].id}" target="_blank" title="Rules 37">Rules 37</a></strong> or <strong><a linktype="document" id="{definition_docs["rule-173.pdf"].id}" target="_blank" title="173">173</a></strong>.',
                "anchortag": "AT_ISSUE",
            },
            {
                "question": "Audit",
            ...
            {
                "question": "Brief",
                "answer": f'A brief is a formal document normally filed by each party after the trial in a regular case. A brief contains a table of contents, a statement of the issues, proposed findings of facts, points of law relied upon, argument and analysis. See <strong><a linktype="document" id="{definition_docs["rule-151.pdf"].id}" target="_blank" title="Rule 151">Rule 151</a></strong>.',
                "anchortag": "BRIEF",
            },
            {
            ...
            {
                "question": "CDP",
                "answer": "Collection Due Process (CDP) refers to cases in which the collection of taxes is being made by IRS lien or levy under I.R.C. sections 6320 and/or 6330. A CDP case has a docket number ending in <b>L</b>, for example, 77899-14L.",
                "anchortag": "CDP",
            },
            {
                "question": "Certificate of Service",
                "answer": "A <strong>Certificate of Service</strong> is used to show that you have sent or delivered documents to another party, typically the opposing counsel.",
            ...
            {
                "question": "Petition",
                "answer": f'The document a taxpayer files (along with a copy of a Notice of Deficiency or Notice of Determination) explaining to the Court why they disagree with the Internal Revenue Service. A case cannot be heard without a timely filed <strong><a linktype="document" id="{definition_docs["Petition_Kit.pdf"].id}" target="_blank" title="petition">petition</a></strong>.',
                "anchortag": "PETITION",
            },
            {
                "question": "Petitioner",
            ...
            },
            {
                ...
                "answer": f'A written document submitted to the Court by each party providing a brief summary of their case. Petitioners may use the form provided <strong><a linktype="document" id="{definition_docs["Pretrial_Memorandum_Form_old.pdf"].id}" target="_blank" title="here">here</a></strong>.',
            ...
            {
                "question": "Reply",
                "answer": f'In some limited circumstances a petitioner is required to respond to respondent\'s answer. A petitioner has 45 days from the date of service of the answer within which to file a reply if one is required. <strong><a linktype="document" id="{definition_docs["rule-37.pdf"].id}" target="_blank" title="Rule 37">Rule 37</a></strong> and <strong><a linktype="document" id="{definition_docs["rule-173.pdf"].id}" target="_blank" title="Rule 173">Rule 173</a></strong>.',
                "anchortag": "REPLY",
            },
            {
                "question": "Request for Place of Trial",
                "answer": f'This document (<strong><a linktype="document" id="{definition_docs["Form_5_Request_for_Place_of_Trial.pdf"].id}" target="_blank" title="Tax Court Form 5">Tax Court Form 5</a></strong>) is filed with a petition and asks the Court for a trial in a particular city.',
            ...
            },
            {
                ...
                "answer": f'A document (<strong><a linktype="document" id="{definition_docs["Form_4_Statement_of_Taxpayer_Identification_Number.pdf"].id}" target="_blank" title="Tax Court Form 4">Tax Court Form 4</a></strong>) submitted with a petition providing the taxpayer\'s name and Social Security (or other taxpayer ID) number; this document is not filed or made available to the public.',
                "anchortag": "STIN",
            },
            {
        ...
        # Create the EnhancedStandardPage with combined definitions (no navigation_ribbon)
        new_page = home_page.add_child(
            instance=EnhancedStandardPage(
                ...
                body=[
                    {"type": "questionanswers", "value": all_questions},
                ],
            )
        )
        new_page.save_revision().publish()
        logger.info(
            f"Created the '{title}' page with {len(all_questions)} combined entries."
        )

        ...
        questions = [
            {
                ...
                "answer": {
                    "rich_text": """<ul>
                              <li>Yes. Petitions can be filed electronically in DAWSON. For more information, see the <a href="/dawson_user_guides" target="_blank" title="DAWSON User Guides">User Guides</a>.</li>
                ...
                "answer": {
                    "rich_text": """<ul>
                                  ...
                                  <li>Sealed Documents
                                    ...
                                    <li>For more information, see the <a href="/dawson_user_guides" target="_blank" title="DAWSON User Guides">User Guides</a>.</li>
                              </ul>"""
                },
                "anchortag": "FAQS5",
            },

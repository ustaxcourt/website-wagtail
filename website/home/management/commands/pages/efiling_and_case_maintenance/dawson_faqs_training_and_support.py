                    ...
                    "value": [
                        {
                            ...
                            "answer": f"""The <a target="_blank" href="/dawson" title="DAWSON">DAWSON</a>
                            page has helpful information, including this <a href="https://us02web.zoom.us/rec/play/EZTpkvLfDeXoLeW2YzhdTgpBcKoC10NumGESfgR2Aorw_E85V6vwwpCCmQOEzW9GI9M-0fvLZTxMPr_T.wWcxq5k6tZ3GI8OP" title="DAWSON Training Video">training video</a>.
                            <ul>
                                <li><a href="{dawson_faqs_training_and_support_doc["DAWSON_Public_Training_Guide.pdf"]}" target="_blank" title="DAWSON Public Training Guide">DAWSON Public Training Guide: DAWSON_Public_Training_Guide.pdf</a></li>
                                <li><a href="{dawson_faqs_training_and_support_doc["DAWSON_Petitioner_Training_Guide.pdf"]}" target="_blank" title="DAWSON Public Training Guide">DAWSON Petitioner Training Guide: DAWSON_Petitioner_Training_Guide.pdf</a></li>
                                <li><a href="{dawson_faqs_training_and_support_doc["DAWSON_Practitioner_Training_Guide.pdf"]}" target="_blank" title="DAWSON Public Training Guide">DAWSON Practitioner Training Guide: DAWSON_Practitioner_Training_Guide.pdf</a></li>
                            </ul>""",
                            "anchortag": "FAQS1",
                        },
                        {
                            ...
                            "answer": """<ul>
                                          ...
                                          <li>User feedback and error reporting can also be submitted to <a href=\"mailto:dawson.support@ustaxcourt.gov\" title=\"Contact DAWSON Support\">dawson.support@ustaxcourt.gov</a>.</li>

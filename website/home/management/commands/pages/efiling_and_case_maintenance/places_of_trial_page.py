...
all_dpt_cities_wag_1327 = [
    ...
    },
    {
        ...
        "cities": [
            {
                "name": "Austin",
                "note": "No permanent courtoom. See notice of trial for address.",
                "address": "",
            },
            {
                "name": "Dallas",
...
class PlacesOfTrialPageInitializer(PageInitializer):
    ...
    def create_page_info(self, home_page):
        ...
        places_of_trial_data = [
            ...
            for state_data in dpt_cities_to_use
        ]
            ...
            body=[
                {
                    "type": "alert_message",
                    "value": {
                        "message": '<p data-block-key="t3gy1"><b>Addresses are trial locations only</b><br/>Always address mail to:<br/><br/>United States Tax Court<br/>400 Second Street NW<br/>Washington, DC 20217-0002</p>',
                    },
                }
            ],
            show_in_menus=True,

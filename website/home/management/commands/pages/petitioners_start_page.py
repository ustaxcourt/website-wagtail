    ...
    def create_page_info(self, home_page):
        ...
        questions = [
            ...
            },
            {
                ...
                "answer": f'Yes. You should also submit a <strong><a href="{petitioners_docs["Form_4_Statement_of_Taxpayer_Identification_Number.pdf"]}" target="_blank" title="Statement of Taxpayer Identification Number">Statement of Taxpayer Identification Number </a></strong>(Form 4) and a <strong><a href="{petitioners_docs["Form_5_Request_for_Place_of_Trial.pdf"]}" target="_blank" title="Request for Place of Trial">Request for Place of Trial</a></strong> (Form 5), which tells the Tax Court where you would like to have your trial held. Select from the list of <strong><a href="https://ustaxcourt.gov/dpt_cities.html" title="Places of Trial">cities</a></strong> in which the Tax Court holds trial sessions. <a href="https://www.ustaxcourt.gov/resources/images/city_map.gif" title="Places of trial map">A map displaying the cities in which the Tax Court holds trial sessions</a> is also available.',
                "anchortag": "START29",
            },
            {

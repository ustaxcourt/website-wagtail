    ...
    def create_page_info(self, home_page):
        ...
        questions = [
            ...
            },
            {
                ...
                "answer": 'There are <strong><a href="clinics.html" target="_blank" title="Clinics &amp;  Pro Bono Programs">tax clinics throughout the United States participating in the Tax Court\'s Clinical Program</a></strong>. You may want to contact one of the <strong><a href="resources/clinics/clinics.pdf" target="_blank" title="Low Income Taxpayer Clinics">clinics</a></strong> in your geographic area. The Taxpayer Advocate of the Internal Revenue Service has a more <strong><a href="redirect_clinic.html" target="_blank" title="Redirect Clinic">extensive clinic list</a></strong> available on the IRS Web site (<strong><a href="redirect_irs.html" target="_blank" title="Redirect IRS">www.irs.gov</a></strong>). The Tax Court will send you information about tax clinics when you file your petition. The Court will also send tax clinic information when the Notice of Trial is sent to you. These tax clinics are not part of the Internal Revenue Service or the Tax Court. The Tax Court does not endorse or recommend any particular tax clinic or organization.',
                "anchortag": "START4",
            },
            {
                "question": "If I want to represent myself or if I don't qualify for representation by a tax clinic, can I represent myself?",
                "answer": 'You may file a petition with the Tax Court even if you do not have a representative. You may also present your case to a Judge without being represented. This guide is provided to help you in that process. If you decide to file a petition and to proceed to trial without a representative, you must pay close attention to all the Tax Court orders and notices you receive and all the instructions provided. A petitioner who is not represented is still required to abide by the <strong><a href="rules.html" title="Rules of Practice and Procedure">Tax Court Rules of Practice and Procedure</a></strong> (Rules). If you have difficulty reading, writing, or understanding written instructions, you should seek help.',
                "anchortag": "START5",
            },
            {
                "question": "What should I do if I don't speak and/or understand English very well?",
                "answer": 'All proceedings in the Tax Court are in English. The Tax Court does not have staff available to assist non-English speaking petitioners. The <strong><a href="rules.html" title="Tax Court Rules">Tax Court Rules</a></strong> provide that it is the responsibility of the parties to make arrangements for and compensate interpreters.<br/><br/>Many Low Income Taxpayer Clinics (LITCs) offer services in languages other than English. You can review <strong><a href="resources/clinics/clinics.pdf" target="_blank" title="LITC List">the Court\'s list</a></strong> or the <strong><a href="redirect_clinic.html" target="_blank" title="Redirect Clinic">Taxpayer Advocate\'s (IRS) more extensive list</a></strong> and find a clinic convenient to you that may provide the language assistance you need.',
                "anchortag": "START6",
            },
            {
            ...
            },
            {
                ...
                "answer": 'Yes. You should also submit a <strong><a href="resources/forms/Form_4_Statement_of_Taxpayer_Identification_Number.pdf" target="_blank" title="Statement of Taxpayer Identification Number">Statement of Taxpayer Identification Number </a></strong>(Form 4) and a <strong><a href="resources/forms/Form_5_Request_for_Place_of_Trial.pdf" target="_blank" title="Request for Place of Trial">Request for Place of Trial</a></strong> (Form 5), which tells the Tax Court where you would like to have your trial held. Select from the list of <strong><a href="dpt_cities.html" title="Places of Trial">cities</a></strong> in which the Tax Court holds trial sessions. A map displaying the cities in which the Tax Court holds trial sessions is also available.',
                "anchortag": "START28",
            },
            {
                "question": "Where may I request a place of trial if I elected to conduct my case as a small tax case?",
                "answer": 'If you elected to conduct your case as a small tax case, you may request a place of trial in any of the cities listed on <strong><a href="resources/forms/Form_5_Request_for_Place_of_Trial.pdf" target="_blank" title="Request for Place of Trial">Form 5, Request for Place of Trial</a></strong>. Place an "X" in only one box to request your place of trial.',
                "anchortag": "START29",
            },
            {
                "question": "Where may I request a place of trial if I elected to conduct my case as a regular tax case?",
                "answer": 'If you elected to conduct your case as a regular case, you may request any of the cities not marked with an asterisk on <strong><a href="resources/forms/Form_5_Request_for_Place_of_Trial.pdf" target="_blank" title="Request for Place of Trial">Form 5, Request for Place of Trial</a></strong>. Place an "X" in only one box to request your place of trial. You may not select one of the cities marked with an asterisk (*). If you are eFiling a petition, you will only be asked to choose from among the cities that are available for regular tax cases.',
                "anchortag": "START30",
            },
            {
            ...
            },
            {
                ...
                "answer": 'Yes. File a <strong><a href="resources/forms/Motion_to_Proceed_Remotely.pdf" target="_blank" title="Motion to Proceed Remotely">Motion To Proceed Remotely</a></strong>. A Motion To Proceed Remotely may be filed at the time a petition is filed and up until 31 days before the first day of the trial session. The granting of the motion is at the Judge\'s discretion. If the Judge grants the Motion To Proceed Remotely, the parties will be provided with detailed instructions, including the date, time, and Zoomgov information for the remote (virtual) proceeding',
                "anchortag": "START32",
            },
            {
                "question": "How can I be sure that I have done everything correctly?",
                "answer": 'A checklist for Filing a paper <strong><a href="resources/forms/Petition_Kit.pdf" target="_blank" title="Petition Kit">Petition</a></strong> is below. If you are eFiling a petition, see instead <strong><a href="efile_a_petition.html" title="How to eFile a Petition">How to eFile a Petition</a></strong>.<br/><br/>Have I:<br/><br/><ul class="disc"><li>Printed my full name on the petition, signed the petition, and included my mailing address and telephone number?</li><li>If it is a joint petition, printed the name of my spouse and included my spouse\'s signature?</li><li>Included a check or money order for $60 made out to "Clerk, United States Tax Court"?</li><li>Filled in all information required on the petition form?</li><li>Completed the Statement of Taxpayer Identification Number (Form 4)?</li><li>Omitted or removed from the petition, from any enclosed notice of deficiency or notice of determination, and from any other document (other than Form 4) my Social Security number and certain other confidential personal and financial information as specified in the <strong><a href="resources/forms/Privacy-_Notice.pdf" target="_blank" title="Privacy Notice">Notice Regarding Privacy and Public Access to Case Files</a></strong>?</li><li>Completed Form 5 (Request for Place of Trial) to indicate where I want to have my trial held?</li><li>Placed in an envelope the (1) original signed petition, (2) Statement of Taxpayer Identification Number, (3) Request for Place of Trial, and (4) check or money order for $60 for mailing to: United States Tax Court, 400 Second Street, N.W., Washington, D.C. 20217?</li><li>Either hand delivered the petition or mailed the petition using the U.S. Postal Service or a designated private delivery service and kept some evidence of the date I mailed the petition to the Tax Court (U.S. Postal Service postmarked certified or registered mail receipt or receipt from the designated private delivery service)?</li><li>Retained a copy of the petition for my records?</li></ul>The Court will send you a Notice of Receipt of Petition once your petition is received.',
                "anchortag": "START33",
            },
            {
            ...
            },
            {
                ...
                "answer": 'A response to a motion should be sent both to the Court and to respondent\'s counsel (and the other parties, if any, in the case). Attach a Certificate of Service to the copy you send to the Court. If you are filing a response to a motion electronically, see the <strong><a href="dawson_user_guides.html" title="DAWSON User Guides">DAWSON User Guides</a></strong>.',
                "anchortag": "START43",
            },
            {
            ...
            },
            {
                ...
                "answer": 'You should file a <strong><a href="resources/forms/NOCOA_Form_10.pdf" target="_blank" title="Notice of Change of Address">Notice of Change of Address</a></strong> (Form 10) with the Tax Court. You should send a copy to the attorney representing the IRS. If you have moved to a new geographic area, you may want to change the place of trial to a city closer to your new address. If you want a different <strong><a href="dpt_cities.html" title="Places of Trial">place of trial</a></strong>, you should send a Motion To Change Place of Trial to the Tax Court and send a copy to the IRS attorney. Please identify the city in which you now want your trial to be held.',
                "anchortag": "START47",
            },
        ]

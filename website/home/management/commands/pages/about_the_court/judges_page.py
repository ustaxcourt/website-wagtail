...
class JudgesPageInitializer(PageInitializer):
    ...
    def update(self):
        ...
        schedule_datetime_aware_edt = datetime(
            2025, 5, 20, 17, 45, 0, tzinfo=eastern_tz
        )
        ...
        current_chief_judge_profile.bio = "Chief Judge. B.S., Boston College 1985; J.D., University of Notre Dame Law School, 1990. Admitted to Massachusetts Bar, 1991 and District Columbia Bar, 1992. Legislative Director for Congressman Richard E. Neal, Member of the Ways and Means Committee, 1990 to 1998. Associate and partner at Baker & Hostetler LLP, Washington, D.C. 1998-2005. Tax Counsel for Senator John F. Kerry, Member of Senate Finance Committee, 2005-2012. Appointed by President Obama as Judge of the United States Tax Court; sworn in on May 4, 2012, for a term ending on May 3, 2027. Elected as Chief Judge for a two-year term effective June 1, 2022. Re-elected as Chief Judge for a two-year term effective June 1, 2024. Stepped down from Chief Judge on May 31, 2025."

        current_chief_judge_profile.save_revision(
            log_action=True,
            changed=True,
        ...
        live_chief_judge_role.go_live_at = schedule_datetime_aware_edt

        # Modify the instance in memory to reflect the future state
        _ = live_chief_judge_role.save_revision(
            user=None,
            log_action=True,
            changed=True,
            approved_go_live_at=schedule_datetime_aware_edt,

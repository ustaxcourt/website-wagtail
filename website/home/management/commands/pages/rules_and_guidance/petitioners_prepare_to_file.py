    ...
    def create_page_info(self, home_page):
        ...
        new_page = home_page.add_child(
            instance=PetitionerExperiencePage(
                title=title,
                introductory_text="The United States Tax Court encourages electronic filing through DAWSON, the court’s electronic filing and case management system. Note: If filing using DAWSON, once you start this process you won’t be able to save your work and come back to it. Petitioners who file by paper cannot immediately switch to electronic access. To protect your information, the Court will mail identity verification instructions to your address of record. Switching to electronic access will be available only after the verification process is complete. Consider filing electronically from the start to get electronic access to your case immediately.",
                slug=slug,
                seo_title=title,

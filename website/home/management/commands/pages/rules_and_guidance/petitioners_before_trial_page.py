    ...
    def create_page_info(self, home_page):
        ...
        questions = [
            ...
            },
            {
                ...
                "answer": f'A subpoena is an order issued by the Tax Court (1) directing a person to appear and testify at a scheduled Tax Court Trial Session or (2) directing a person to appear at a deposition prearranged at a specific time and location. The subpoena may include directions for the person (witness) to produce specific books, papers, documents, electronically stored information, or tangible things. See Tax Court Rules <a href="{petitioners_docs["Rule-147.pdf"]}" target="_blank" title="Rule 147">147</a>,<a href="{petitioners_docs["Rule-74(amended).pdf"]}" target="_blank" title="Rule 74">74</a> and <a href="{petitioners_docs["Rule-81.pdf"]}" target="_blank" title="Rule 81">81</a>.',
                "anchortag": "START4",
            },
            {
                "question": "When is it appropriate to use a Tax Court subpoena?",
                "answer": 'If you can’t get documents you need for Court and/or you need a witness to testify at a deposition or at trial, you can consider serving a subpoena. Most often, the parties agree to documents in the stipulation process and you don’t need a subpoena. (<a href="#START2">See the discussion above about stipulation of facts</a>). Sometimes, however, documents are not readily available or a witness is uncooperative, and a subpoena may be needed to get a witness to testify or to produce a document to assist you in proving your case.',
                "anchortag": "START5",
            },
            {
                "question": "How do I obtain and serve a Tax Court subpoena?",
                "answer": f"""You may obtain a form for a <a href="{petitioners_docs["Subpoena_Appear_Testify_Hearing_Or_Trial.pdf"]}" target="_blank" title="Subpoena to Appear and Testify at a Hearing or Trial (Form 14A)">Subpoena to Appear and Testify at a Hearing or Trial (Form 14A)
                            </a> or a <a href="{petitioners_docs["Subpoena_To_Testify_Deposition.pdf"]}" target="_blank" title="Subpoena to Testify at a Deposition (Form 14B)">Subpoena to Testify at a Deposition (Form 14B)</a>
                           under the <a href="/case-related-forms" title="Case Related Forms">“Forms”</a>
                           tab on the Court’s internet website.You may also obtain a copy of subpoena form 14A from a trial clerk at a trial session.
                           <br>
                           <br>
                           ...
                           at the bottom of the subpoena form. See <a href="{petitioners_docs["Rule-147.pdf"]}" target="_blank" title="Rule 147">Tax Court Rule 147(c)</a>.
            ...
            },
            {
                ...
                "answer": f'Yes. If you as a petitioner are serving a subpoena on a witness, you must pay fees to the witness in advance equal to one day’s attendance and mileage. See <a href="{petitioners_docs["Rule-147.pdf"]}" title="Rule 147">Tax court Rule 147(c)</a>. These fees must be paid to the witness when the subpoena is served. A witness is entitled to the same fees for attendance and transportation as witnesses in the United States District Courts. See <a href="{petitioners_docs["Rule-148.pdf"]}" title="Rule 148">Tax court Rule 148</a>. For more detail as to the amount of the fees and travel allowances go to the definition of Subpoena in the <a href="/petitioners-glossary" title="Glossary">Glossary</a>.',
                "anchortag": "START7",
            },
            {
            ...
            },
            {
                ...
                "answer": f'As a general matter you should comply with a subpoena. If you are served with a subpoena, and you believe it was issued in error, is unreasonable or oppressive, or was not properly served, you may file a Motion To Quash the subpoena with the Court. If you fail to appear as directed by a subpoena, you may be found to be in contempt of Court. See <a href="{petitioners_docs["Rule-147.pdf"]}" target="_blank" title="Rule 147">Rule 147(e)</a>.',
                "anchortag": "START9",
            },
            {
                "question": "How will I know when and where my trial will take place?",
                "answer": f"""The Tax Court will issue either a<a href="{petitioners_docs["Sample_Notice_Setting_Case_for_Trial_S_cases.pdf"]}" target="_blank" title = "Notice for S Cases " > notice
                             for S cases </a>or a <a href="{petitioners_docs["Sample_Notice_Setting_Case_for_Trial_R_cases.pdf"]}" target="_blank" title="Notice for Regular Cases" > notice for regular cases </a>
            ...
            },
            {
                ...
                "answer": f'A pretrial memorandum form is attached as part of the <a href="{petitioners_docs["SPTO_regular_sample.pdf"]}" target="_blank" title="Standing Pretrial Order">Standing Pretrial Order</a> or <a href="{petitioners_docs["SPTO_small_sample.pdf"]}" target="_blank" title="Standing Pretrial Order For Small Tax Cases">Standing Pretrial Order For Small Tax Cases</a>. You must file a pretrial memorandum in a regular case. You should submit a pretrial memorandum in an S case. The Court encourages all parties to file a pretrial memorandum. Preparing the pretrial memorandum may help you in organizing your case and help the Judge to understand your position. Carefully read the instructions in the Standing Pretrial Order or Notice. Follow the form and instructions. Send your pretrial memorandum to the Court, and send a copy to the IRS attorney.',
                "anchortag": "START12",
            },
            {

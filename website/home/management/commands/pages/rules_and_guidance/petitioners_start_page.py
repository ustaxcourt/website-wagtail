    ...
    def create_page_info(self, home_page):
        ...
        questions = [
            ...
            },
            {
                ...
                "answer": f'If you elected to conduct your case as a small tax case, you may request a place of trial in any of the cities listed on <strong><a href="{petitioners_docs["Form_5_Request_for_Place_of_Trial.pdf"]}" target="_blank" title="Request for Place of Trial">Form 5, Request for Place of Trial</a></strong>. Place an "X" in only one box to request your place of trial.',
                "anchortag": "START30",
            },
            {
                "question": "Where may I request a place of trial if I elected to conduct my case as a regular tax case?",
                "answer": f'If you elected to conduct your case as a regular case, you may request any of the cities not marked with an asterisk on <strong><a href="{petitioners_docs["Form_5_Request_for_Place_of_Trial.pdf"]}" target="_blank" title="Request for Place of Trial">Form 5, Request for Place of Trial</a></strong>. Place an "X" in only one box to request your place of trial. You may not select one of the cities marked with an asterisk (*). If you are eFiling a petition, you will only be asked to choose from among the cities that are available for regular tax cases.',
                "anchortag": "START31",
            },
            {
            ...
            },
            {
                ...
                "answer": f'Yes. File a <strong><a href="{petitioners_docs["Motion_to_Proceed_Remotely.pdf"]}" target="_blank" title="Motion to Proceed Remotely">Motion To Proceed Remotely</a></strong>. A Motion To Proceed Remotely may be filed at the time a petition is filed and up until 31 days before the first day of the trial session. The granting of the motion is at the Judge\'s discretion. If the Judge grants the Motion To Proceed Remotely, the parties will be provided with detailed instructions, including the date, time, and Zoomgov information for the remote (virtual) proceeding',
                "anchortag": "START33",
            },
            {

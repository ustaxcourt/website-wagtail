        ...
        questions = [
            {
                ...
                "answer": f'You must file a <strong><a linktype="document" id="{petitioners_docs["Petition_Kit.pdf"].id}" target="_blank" title="Petition Kit">petition</a></strong> to begin a case in the Tax Court. You can file a paper petition by mail or in person, or you can file an electronic petition through the Court\'s <strong><a href="/dawson" title="DAWSON">DAWSON</a></strong> system. <br/><br/>A party who files a petition in response to an IRS notice of deficiency, notice of determination, or notice of certification is called the "petitioner". The Commissioner of Internal Revenue is referred to as the "respondent" in Tax Court cases.',
                "anchortag": "START1",
            },
            {
            ...
            },
            {
                ...
                "answer": f'There are <strong><a href="/clinics"  title="Clinics &amp;  Pro Bono Programs">tax clinics throughout the United States participating in the Tax Court\'s Clinical Program</a></strong>. You may want to contact one of the <strong><a linktype="document" id="{petitioners_docs["clinics.pdf"].id}" target="_blank" title="Low Income Taxpayer Clinics">clinics</a></strong> in your geographic area. The Taxpayer Advocate of the Internal Revenue Service has a more <strong><a href="https://www.irs.gov/advocate/low-income-taxpayer-clinics/low-income-taxpayer-clinic-map" target="_blank" title="Redirect Clinic">extensive clinic list</a></strong> available on the IRS Web site (<strong><a href="https://www.irs.gov/" target="_blank" title="Redirect IRS">www.irs.gov</a></strong>). The Tax Court will send you information about tax clinics when you file your petition. The Court will also send tax clinic information when the Notice of Trial is sent to you. These tax clinics are not part of the Internal Revenue Service or the Tax Court. The Tax Court does not endorse or recommend any particular tax clinic or organization.',
                "anchortag": "START4",
            },
            {
                "question": "If I want to represent myself or if I don't qualify for representation by a tax clinic, can I represent myself?",
                "answer": 'You may file a petition with the Tax Court even if you do not have a representative. You may also present your case to a Judge without being represented. This guide is provided to help you in that process. If you decide to file a petition and to proceed to trial without a representative, you must pay close attention to all the Tax Court orders and notices you receive and all the instructions provided. A petitioner who is not represented is still required to abide by the <strong><a href="/rules" title="Rules of Practice and Procedure">Tax Court Rules of Practice and Procedure</a></strong> (Rules). If you have difficulty reading, writing, or understanding written instructions, you should seek help.',
                "anchortag": "START5",
            },
            {
                "question": "What should I do if I don't speak and/or understand English very well?",
                "answer": f'All proceedings in the Tax Court are in English. The Tax Court does not have staff available to assist non-English speaking petitioners. The <strong><a href="/rules" title="Tax Court Rules">Tax Court Rules</a></strong> provide that it is the responsibility of the parties to make arrangements for and compensate interpreters.<br/><br/>Many Low Income Taxpayer Clinics (LITCs) offer services in languages other than English. You can review <strong><a linktype="document" id="{petitioners_docs["clinics.pdf"].id}" target="_blank" title="LITC List">the Court\'s list</a></strong> or the <strong><a href="https://www.irs.gov/advocate/low-income-taxpayer-clinics/low-income-taxpayer-clinic-map" target="_blank" title="Redirect Clinic">Taxpayer Advocate\'s (IRS) more extensive list</a></strong> and find a clinic convenient to you that may provide the language assistance you need.',
                "anchortag": "START6",
            },
            {
            ...
            },
            {
                ...
                "answer": f'\n<strong><a linktype="document" id="{petitioners_docs["Petition_Simplified_Form_2.pdf"].id}" target="_blank" title="Petition Form 2">Paper petitions</a></strong> must be filed with the Tax Court in Washington, D.C. You may hand deliver it to the Tax Court between 8 a.m. and 4:30 p.m. (Eastern time), or mail it to:<br/><br/>United States Tax Court<br/>400 Second Street, N.W.<br/>Washington, D.C. 20217-0002<br/><br/>If you are unable to use the form from this Web site, write a letter to the Tax Court stating that you want to file a petition and that you would like any necessary forms and documents sent to you. The letter should include the amount in dispute, your name, your address, your telephone number, the year(s) at issue in your case, and a list of the errors you believe the IRS made. Include a copy of the IRS notice (see privacy discussion below) that you wish to dispute and follow the mailing procedures described above.<br/><br/>You may also file a petition electronically. E-filed petitions will be submitted electronically through the DAWSON case management system. For more information, see "Filing a Petition" at <strong><a href="/dawson" title="DAWSON">https://ustaxcourt.gov/dawson</a></strong>.',
                "anchortag": "START15",
            },
            {
                "question": "How can I protect the privacy of my Social Security number?",
                "answer": f'You should submit <strong><a linktype="document" id="{petitioners_docs["Form_4_Statement_of_Taxpayer_Identification_Number.pdf"].id}" target="_blank" title="Statement of Taxpayer Identification Number">Form 4, Statement of Taxpayer Identification Number,</a></strong> when you file your petition, and redact (delete) your Social Security number or Employer Identification number from any notice you attach to your petition and from any other document you file with the Court. The word redact means to remove or delete information. See <strong><a linktype="document" id="{petitioners_docs["Rule-27.pdf"].id}" target="_blank" title="Rule 27">Tax Court Rule 27</a></strong>. <strong>Do not include your Social Security number on any document you send to the Court (except Form 4).</strong>\n',
                "anchortag": "START16",
            },
            {
            ...
            },
            {
                ...
                "answer": f'The simplest way to delete or redact is to use a black marker and black out the numbers or information you want to be private. For example, if the notice you received from the IRS has your Social Security number (000-00-0000), you should black out the number when you attach the notice to the petition. Do not write these numbers on your petition, or on any other documents submitted to the Court. You should write your Social Security number on <strong><a linktype="document" id="{petitioners_docs["Form_4_Statement_of_Taxpayer_Identification_Number.pdf"].id}" target="_blank" title="Statement of Taxpayer Identification Number">Form 4, Statement of Taxpayer Identification Number</a></strong>, which will not be available to the public.',
                "anchortag": "START18",
            },
            {
            ...
            },
            {
                ...
                "answer": f'Yes. You should also submit a <strong><a linktype="document" id="{petitioners_docs["Form_4_Statement_of_Taxpayer_Identification_Number.pdf"].id}" target="_blank" title="Statement of Taxpayer Identification Number">Statement of Taxpayer Identification Number </a></strong>(Form 4) and a <strong><a linktype="document" id="{petitioners_docs["Form_5_Request_for_Place_of_Trial.pdf"].id}" target="_blank" title="Request for Place of Trial">Request for Place of Trial</a></strong> (Form 5), which tells the Tax Court where you would like to have your trial held. Select from the list of <strong><a href="/dpt-cities" title="Places of Trial">cities</a></strong> in which the Tax Court holds trial sessions. <a href="https://www.ustaxcourt.gov/resources/images/city_map.gif" title="Places of trial map">A map displaying the cities in which the Tax Court holds trial sessions</a> is also available.',
                "anchortag": "START29",
            },
            {
                "question": "Where may I request a place of trial if I elected to conduct my case as a small tax case?",
                "answer": f'If you elected to conduct your case as a small tax case, you may request a place of trial in any of the cities listed on <strong><a linktype="document" id="{petitioners_docs["Form_5_Request_for_Place_of_Trial.pdf"].id}" target="_blank" title="Request for Place of Trial">Form 5, Request for Place of Trial</a></strong>. Place an "X" in only one box to request your place of trial.',
                "anchortag": "START30",
            },
            {
                "question": "Where may I request a place of trial if I elected to conduct my case as a regular tax case?",
                "answer": f'If you elected to conduct your case as a regular case, you may request any of the cities not marked with an asterisk on <strong><a linktype="document" id="{petitioners_docs["Form_5_Request_for_Place_of_Trial.pdf"].id}" target="_blank" title="Request for Place of Trial">Form 5, Request for Place of Trial</a></strong>. Place an "X" in only one box to request your place of trial. You may not select one of the cities marked with an asterisk (*). If you are eFiling a petition, you will only be asked to choose from among the cities that are available for regular tax cases.',
                "anchortag": "START31",
            },
            {
            ...
            },
            {
                ...
                "answer": f'Yes. File a <strong><a linktype="document" id="{petitioners_docs["Motion_to_Proceed_Remotely.pdf"].id}" target="_blank" title="Motion to Proceed Remotely">Motion To Proceed Remotely</a></strong>. A Motion To Proceed Remotely may be filed at the time a petition is filed and up until 31 days before the first day of the trial session. The granting of the motion is at the Judge\'s discretion. If the Judge grants the Motion To Proceed Remotely, the parties will be provided with detailed instructions, including the date, time, and Zoomgov information for the remote (virtual) proceeding',
                "anchortag": "START33",
            },
            {
                "question": "How can I be sure that I have done everything correctly?",
                "answer": f'A checklist for Filing a paper <strong><a linktype="document" id="{petitioners_docs["Petition_Kit.pdf"].id}" target="_blank" title="Petition Kit">Petition</a></strong> is below. If you are eFiling a petition, see instead <strong><a href="/efile-a-petition" title="How to eFile a Petition">How to eFile a Petition</a></strong>.<br/><br/>Have I:<br/><br/><ul class="disc"><li>Printed my full name on the petition, signed the petition, and included my mailing address and telephone number?</li><li>If it is a joint petition, printed the name of my spouse and included my spouse\'s signature?</li><li>Included a check or money order for $60 made out to "Clerk, United States Tax Court"?</li><li>Filled in all information required on the petition form?</li><li>Completed the Statement of Taxpayer Identification Number (Form 4)?</li><li>Omitted or removed from the petition, from any enclosed notice of deficiency or notice of determination, and from any other document (other than Form 4) my Social Security number and certain other confidential personal and financial information as specified in the <strong><a linktype="document" id="{petitioners_docs["Privacy-_Notice.pdf"].id}" target="_blank" title="Privacy Notice">Notice Regarding Privacy and Public Access to Case Files</a></strong>?</li><li>Completed Form 5 (Request for Place of Trial) to indicate where I want to have my trial held?</li><li>Placed in an envelope the (1) original signed petition, (2) Statement of Taxpayer Identification Number, (3) Request for Place of Trial, and (4) check or money order for $60 for mailing to: United States Tax Court, 400 Second Street, N.W., Washington, D.C. 20217?</li><li>Either hand delivered the petition or mailed the petition using the U.S. Postal Service or a designated private delivery service and kept some evidence of the date I mailed the petition to the Tax Court (U.S. Postal Service postmarked certified or registered mail receipt or receipt from the designated private delivery service)?</li><li>Retained a copy of the petition for my records?</li></ul>The Court will send you a Notice of Receipt of Petition once your petition is received.',
                "anchortag": "START34",
            },
            {

...
petitioners_docs = {
    ...
    "Motion_to_Proceed_Remotely.pdf": "",
    "NOCOA_Form_10.pdf": "",
    "Notice_of_Receipt_of_Petition.pdf": "",
    "Petition_Kit.pdf": "",
        ...
        questions = [
            {
                ...
                "answer": f'You must file a <a href="{petitioners_docs["Petition_Kit.pdf"]}" target="_blank" title="Petition Kit">petition</a> to begin a case in the Tax Court. You can file a paper petition by mail or in person, or you can file an electronic petition through the Court\'s <a href="/dawson" title="DAWSON">DAWSON</a> system. <br/><br/>A party who files a petition in response to an IRS notice of deficiency, notice of determination, or notice of certification is called the "petitioner". The Commissioner of Internal Revenue is referred to as the "respondent" in Tax Court cases.',
                "anchortag": "START1",
            },
            {
            ...
            },
            {
                ...
                "answer": f'There are <a href="/clinics" target="_blank" title="Clinics &amp;  Pro Bono Programs">tax clinics throughout the United States participating in the Tax Court\'s Clinical Program</a>. You may want to contact one of the <a href="{petitioners_docs["clinics.pdf"]}" target="_blank" title="Low Income Taxpayer Clinics">clinics</a> in your geographic area. The Taxpayer Advocate of the Internal Revenue Service has a more <a href="https://www.irs.gov/advocate/low-income-taxpayer-clinics/low-income-taxpayer-clinic-map" target="_blank" title="Redirect Clinic">extensive clinic list</a> available on the IRS Web site (<a href="https://www.irs.gov/" target="_blank" title="Redirect IRS">www.irs.gov</a>). The Tax Court will send you information about tax clinics when you file your petition. The Court will also send tax clinic information when the Notice of Trial is sent to you. These tax clinics are not part of the Internal Revenue Service or the Tax Court. The Tax Court does not endorse or recommend any particular tax clinic or organization.',
                "anchortag": "START4",
            },
            {
                "question": "If I want to represent myself or if I don't qualify for representation by a tax clinic, can I represent myself?",
                "answer": 'You may file a petition with the Tax Court even if you do not have a representative. You may also present your case to a Judge without being represented. This guide is provided to help you in that process. If you decide to file a petition and to proceed to trial without a representative, you must pay close attention to all the Tax Court orders and notices you receive and all the instructions provided. A petitioner who is not represented is still required to abide by the <a href="/rules" title="Rules of Practice and Procedure">Tax Court Rules of Practice and Procedure</a> (Rules). If you have difficulty reading, writing, or understanding written instructions, you should seek help.',
                "anchortag": "START5",
            },
            {
                "question": "What should I do if I don't speak and/or understand English very well?",
                "answer": f'All proceedings in the Tax Court are in English. The Tax Court does not have staff available to assist non-English speaking petitioners. The <a href="/rules" title="Tax Court Rules">Tax Court Rules</a> provide that it is the responsibility of the parties to make arrangements for and compensate interpreters.<br/><br/>Many Low Income Taxpayer Clinics (LITCs) offer services in languages other than English. You can review <a href="{petitioners_docs["clinics.pdf"]}" target="_blank" title="LITC List">the Court\'s list</a> or the <a href="https://www.irs.gov/advocate/low-income-taxpayer-clinics/low-income-taxpayer-clinic-map" target="_blank" title="Redirect Clinic">Taxpayer Advocate\'s (IRS) more extensive list</a> and find a clinic convenient to you that may provide the language assistance you need.',
                "anchortag": "START6",
            },
            {
            ...
            },
            {
                ...
                "answer": f'\n<a href="{petitioners_docs["Petition_Simplified_Form_2.pdf"]}" target="_blank" title="Petition Form 2">Paper petitions</a> must be filed with the Tax Court in Washington, D.C. You may hand deliver it to the Tax Court between 8 a.m. and 4:30 p.m. (Eastern time), or mail it to:<br/><br/>United States Tax Court<br/>400 Second Street, N.W.<br/>Washington, D.C. 20217-0002<br/><br/>If you are unable to use the form from this Web site, write a letter to the Tax Court stating that you want to file a petition and that you would like any necessary forms and documents sent to you. The letter should include the amount in dispute, your name, your address, your telephone number, the year(s) at issue in your case, and a list of the errors you believe the IRS made. Include a copy of the IRS notice (see privacy discussion below) that you wish to dispute and follow the mailing procedures described above.<br/><br/>You may also file a petition electronically. E-filed petitions will be submitted electronically through the DAWSON case management system. For more information, see "Filing a Petition" at <a href="/dawson" title="DAWSON">https://ustaxcourt.gov/dawson</a>.',
                "anchortag": "START15",
            },
            {
                "question": "How can I protect the privacy of my Social Security number?",
                "answer": f'You should submit <a href="{petitioners_docs["Form_4_Statement_of_Taxpayer_Identification_Number.pdf"]}" target="_blank" title="Statement of Taxpayer Identification Numbeer">Form 4, Statement of Taxpayer Identification Number,</a> when you file your petition, and redact (delete) your Social Security number or Employer Identification number from any notice you attach to your petition and from any other document you file with the Court. The word redact means to remove or delete information. See <a href="{petitioners_docs["Rule-27.pdf"]}" target="_blank" title="Rule 27">Tax Court Rule 27</a>. Do not include your Social Security number on any document you send to the Court (except Form 4).\n',
                "anchortag": "START16",
            },
            {
            ...
            },
            {
                ...
                "answer": f'The simplest way to delete or redact is to use a black marker and black out the numbers or information you want to be private. For example, if the notice you received from the IRS has your Social Security number (000-00-0000), you should black out the number when you attach the notice to the petition. Do not write these numbers on your petition, or on any other documents submitted to the Court. You should write your Social Security number on <a href="{petitioners_docs["Form_4_Statement_of_Taxpayer_Identification_Number.pdf"]}" target="_blank" title="Statement of Taxpayer Identification Number">Form 4, Statement of Taxpayer Identification Number</a>, which will not be available to the public.',
                "anchortag": "START18",
            },
            {
            ...
            },
            {
                ...
                "answer": 'Yes. The filing fee is $60. You may pay by check, money order, or using Pay.gov.  <a href="/pay-filing-fee" title="How to Pay the Filing Fee">See https://ustaxcourt.gov/pay-filing-fee</a> for more information. ',
                "anchortag": "START24",
            },
            {
            ...
            },
            {
                ...
                "answer": f'Yes. You should also submit a <a href="{petitioners_docs["Form_4_Statement_of_Taxpayer_Identification_Number.pdf"]}" target="_blank" title="Statement of Taxpayer Identification Number">Statement of Taxpayer Identification Number </a>(Form 4) and a <a href="{petitioners_docs["Form_5_Request_for_Place_of_Trial.pdf"]}" target="_blank" title="Request for Place of Trial">Request for Place of Trial</a> (Form 5), which tells the Tax Court where you would like to have your trial held. Select from the list of <a href="/dpt-cities" title="Places of Trial">cities</a> in which the Tax Court holds trial sessions. <a href="https://www.ustaxcourt.gov/resources/images/city_map.gif" title="Places of trial map">A map displaying the cities in which the Tax Court holds trial sessions</a> is also available.',
                "anchortag": "START29",
            },
            {
                "question": "Where may I request a place of trial if I elected to conduct my case as a small tax case?",
                "answer": f'If you elected to conduct your case as a small tax case, you may request a place of trial in any of the cities listed on <a href="{petitioners_docs["Form_5_Request_for_Place_of_Trial.pdf"]}" target="_blank" title="Request for Place of Trial">Form 5, Request for Place of Trial</a>. Place an "X" in only one box to request your place of trial.',
                "anchortag": "START30",
            },
            {
                "question": "Where may I request a place of trial if I elected to conduct my case as a regular tax case?",
                "answer": f'If you elected to conduct your case as a regular case, you may request any of the cities not marked with an asterisk on <a href="{petitioners_docs["Form_5_Request_for_Place_of_Trial.pdf"]}" target="_blank" title="Request for Place of Trial">Form 5, Request for Place of Trial</a>. Place an "X" in only one box to request your place of trial. You may not select one of the cities marked with an asterisk (*). If you are eFiling a petition, you will only be asked to choose from among the cities that are available for regular tax cases.',
                "anchortag": "START31",
            },
            {
            ...
            },
            {
                ...
                "answer": f'Yes. File a <a href="{petitioners_docs["Motion_to_Proceed_Remotely.pdf"]}" target="_blank" title="Motion to Proceed Remotely">Motion To Proceed Remotely</a>. A Motion To Proceed Remotely may be filed at the time a petition is filed and up until 31 days before the first day of the trial session. The granting of the motion is at the Judge\'s discretion. If the Judge grants the Motion To Proceed Remotely, the parties will be provided with detailed instructions, including the date, time, and Zoomgov information for the remote (virtual) proceeding',
                "anchortag": "START33",
            },
            {
                "question": "How can I be sure that I have done everything correctly?",
                "answer": f'A checklist for Filing a paper <a href="{petitioners_docs["Petition_Kit.pdf"]}" target="_blank" title="Petition Kit">Petition</a> is below. If you are eFiling a petition, see instead <a href="/efile-a-petition" title="How to eFile a Petition">How to eFile a Petition</a>.<br/><br/>Have I:<br/><br/><ul class="disc"><li>Printed my full name on the petition, signed the petition, and included my mailing address and telephone number?</li><li>If it is a joint petition, printed the name of my spouse and included my spouse\'s signature?</li><li>Included a check or money order for $60 made out to "Clerk, United States Tax Court"?</li><li>Filled in all information required on the petition form?</li><li>Completed the Statement of Taxpayer Identification Number (Form 4)?</li><li>Omitted or removed from the petition, from any enclosed notice of deficiency or notice of determination, and from any other document (other than Form 4) my Social Security number and certain other confidential personal and financial information as specified in the <a href="{petitioners_docs["Privacy-_Notice.pdf"]}" target="_blank" title="Privacy Notice">Notice Regarding Privacy and Public Access to Case Files</a>?</li><li>Completed Form 5 (Request for Place of Trial) to indicate where I want to have my trial held?</li><li>Placed in an envelope the (1) original signed petition, (2) Statement of Taxpayer Identification Number, (3) Request for Place of Trial, and (4) check or money order for $60 for mailing to: United States Tax Court, 400 Second Street, N.W., Washington, D.C. 20217?</li><li>Either hand delivered the petition or mailed the petition using the U.S. Postal Service or a designated private delivery service and kept some evidence of the date I mailed the petition to the Tax Court (U.S. Postal Service postmarked certified or registered mail receipt or receipt from the designated private delivery service)?</li><li>Retained a copy of the petition for my records?</li></ul>The Court will send you a Notice of Receipt of Petition once your petition is received.',
                "anchortag": "START34",
            },
            {
            ...
            },
            {
                ...
                "answer": "You should mail a signed original and one copy of any document to the Tax Court. You also should send to the attorney representing the IRS a copy of any document you mail to the Tax Court. Do not forget to include your name and docket number at the top of any document you want to file with the Tax Court. However, do not include your Social Security Number on any document (other than Form 4) you file with the Tax Court. Do include your docket number on any documents you mail to the Court.",
                "anchortag": "START36",
            },
            {
                "question": "What happens after I file my petition?",
                "answer": f'If you filed a paper petition, you will receive a <a href="{petitioners_docs["Notice_of_Receipt_of_Petition.pdf"]}" target="_blank" title="Notice of Receipt of Petition">notice of receipt of petition</a> from the Tax Court by mail acknowledging the filing of the petition. That document will tell you the docket number of your case. If you eFiled your petition, the DAWSON system will provide the docket number. For example, if you file the petition in 2007, the last two digits will be -07. The docket number might look like 1234-07. If you chose, and the Tax Court granted, S case status, the docket number will contain the letter S at the end, for example, 1234-07S. You should include the docket number assigned to you on all letters and documents you send to the Tax Court and to the IRS. Next, an Answer is filed by the IRS. After your petition has been filed, you should send a copy of everything you send to the Tax Court to the attorney representing the IRS. The name and address of the IRS attorney is on the last page of the Answer.',
                "anchortag": "START37",
            },
            {
                "question": "How can I check on the status of my case?",
                "answer": 'Docket records are available through the Tax Court\'s website. The Court\'s case management system <a href="https://dawson.ustaxcourt.gov/" target="_blank" title="DAWSON">DAWSON</a> provides easy access to docket records by allowing you to search using a docket number or individual party name. Orders issued or entered and decisions entered after March 1, 2008, and Tax Court and memorandum opinions starting September 25, 1995 (summary opinions starting January 1, 2001), are available to the public through the Tax Court\'s website without registration for electronic access.<br/><br/>Complete instructions for using DAWSON are available under Reference Materials on the Tax Court\'s website at <a href="/dawson" title="DAWSON">https://ustaxcourt.gov/dawson</a>.',
                "anchortag": "START38",
            },
            {
                "question": "Who can I contact if I have questions?",
                "answer": 'Contact the Office of the Clerk for all case-related questions. You can contact the Tax Court by mail at U.S. Tax Court, 400 Second Street, N.W., Washington, D.C. 20217-0002 or by telephone at (202) 521-0700. <br/><br/>If you need assistance with DAWSON, the Tax Court\'s case management system, email <a href="mailto:dawson.support@ustaxcourt.gov" title="Contact Support">dawson.support@ustaxcourt.gov</a>. <br/><br/>A <a href="/directory" title="Directory">directory</a> is available on the Court\'s website.',
                "anchortag": "START39",
            },
            {
                ...
                "answer": f'A motion is a request filed by one of the parties asking the Tax Court to take some action or asking the Tax Court to direct the other party to do something.<br/><br/>When you send a motion to the Tax Court, you should also send a copy of it to IRS counsel (and the other parties, if any, in the case). Attach a Certificate of Service to the copy you send to the Court. A sample Certificate of Service is available as Form 9 in <strong>Appendix I</strong> of the Rules; there is also a fillable <a href="{petitioners_docs["Certificate_of_Service_Form_-9.pdf"]}" target="_blank" title="Certificate of Service">Certificate of Service</a> form on the Forms page. If you are filing a response to a motion electronically, please see the <strong>Petitioners\' Guide to Electronic Case Access and Filing</strong> for more information.',
                "anchortag": "START40",
            },
            {
                "question": "What are some of the common motions that can be filed?",
                "answer": f'\n<ul class="disc"><li>Motion for continuance</li><li>Motion for leave to file an amended petition</li><li>Motion to change place of trial</li><li>Motion for summary judgment</li><li>Motion for submission of case fully stipulated (<a href="{petitioners_docs["Rule-122.pdf"]}" target="_blank" title="Rule 122">Rule 122</a>)</li><li>Motion for reconsideration of opinion</li><li>Motion to vacate decision</li></ul>',
                "anchortag": "START41",
            },
            {
                "question": "What is a motion for summary judgment? How should I respond to one?",
                "answer": f'\nThe motion. A motion for summary judgment requests a ruling from a judge on some or all of the issues in a case before trial. If a motion for summary judgment is filed, the judge will review the documents submitted by the parties and consider whether the case can be decided without a trial. The party filing the motion must show that there is no genuine dispute of any important fact and that the party filing the motion is entitled to judgment in their favor as a matter of law. See <a href="{petitioners_docs["Rule-121.pdf"]}" target="_blank" title="Rule 121">Rule 121</a>.<br/><br/>Your response. If the Court orders you to file a response to a motion for summary judgment, your response must: specify which factual statements in the motion for summary judgment you dispute, state what you contend the actual facts are, and cite the specific evidence that you rely on to support your factual contentions. That is, you must do more than deny or disagree with the motion. Instead, you must set forth specific facts that establish there is a factual dispute and that a trial is necessary to resolve that dispute. It is not enough merely to claim that a fact is in dispute. You must support your claim that there is a question about a material fact (or facts) by submitting with your response the evidence on which you rely.<br/><br/>Your evidence. Your supporting evidence may include your own sworn affidavit or unsworn declaration given under penalty of perjury. (<a href="{petitioners_docs["Unsworn_Declaration_Form_18.pdf"]}" target="_blank" title="Unsworn Declaration under Penalty of Perjury">Form 18, Unsworn Declaration under Penalty of Perjury</a>). Your declaration can state facts about which you have personal knowledge. If your evidence includes documents, then you should submit those with your response (preferably numbered as Exhibits), and your declaration should identify and authenticate those documents. Your supporting evidence may also include other affidavits, stipulations, admissions, answers to interrogatories, or deposition transcripts.<br/><br/>Legal disputes. A motion for summary judgment may involve not only factual disputes but also legal disputes. If you disagree with the IRS\'s explanation of the law that applies to your case, you should explain your disagreement and cite the statutes, regulations, or other authorities that apply to your case.<br/><br/>Failure to respond. If the IRS files a motion for summary judgment in your case and the Court orders you to file a response, then your failure to file a response may be grounds for granting the motion. See <a href="{petitioners_docs["Rule-121.pdf"]}" target="_blank" title="Rule 121">Rules 121(d)</a> and <a href="{petitioners_docs["Rule-123.pdf"]}" target="_blank" title="Rule 123">123(b)</a>.<br/><br/>Results of summary judgment. If a motion for summary judgment is granted in favor of the IRS, then there will be no trial, and a judgment will be entered against you. Similarly, if you file a motion for summary judgment and it is granted, then there will be no trial, and a judgment will be entered in your favor.',
                "anchortag": "START42",
            },
            {
            ...
            },
            {
                ...
                "answer": 'A response to a motion should be sent both to the Court and to respondent\'s counsel (and the other parties, if any, in the case). Attach a Certificate of Service to the copy you send to the Court. If you are filing a response to a motion electronically, see the <a href="/dawson-user-guides" title="DAWSON User Guides">DAWSON User Guides</a>.',
                "anchortag": "START44",
            },
            {
            ...
            },
            {
                ...
                "answer": 'The Tax Court is a court of public record and files are generally available for viewing in the Records Section at the Tax Court. You may also request that particular documents be copied by contacting the Reproduction Section by mail at United States Tax Court, 400 Second Street, N.W., Washington, D.C. 20217-0002 or by telephone at (202) 521-4683. There is a fee for copy work.<br/><br/>You may view, download, or print any document filed in your case if you have registered for electronic filing. You may also view any orders issued or entered and decisions entered after March 1, 2008, through <a href="https://dawson.ustaxcourt.gov/" target="_blank" title="DAWSON">DAWSON</a> on the Court\'s website without registering for electronic filing.',
                "anchortag": "START47",
            },
            {
                "question": "What if I move or change my address after I file a petition?",
                "answer": f'You should file a <a href="{petitioners_docs["NOCOA_Form_10.pdf"]}" target="_blank" title="Notice of Change of Address">Notice of Change of Address</a> (Form 10) with the Tax Court. You should send a copy to the attorney representing the IRS. If you have moved to a new geographic area, you may want to change the place of trial to a city closer to your new address. If you want a different <a href="/dpt-cities" title="Places of Trial">place of trial</a>, you should send a Motion To Change Place of Trial to the Tax Court and send a copy to the IRS attorney. Please identify the city in which you now want your trial to be held.',
                "anchortag": "START48",
            },
        ]

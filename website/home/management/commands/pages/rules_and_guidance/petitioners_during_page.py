    ...
    def create_page_info(self, home_page):
        ...
        questions = [
            ...
            },
            {
                ...
                "answer": 'Yes. The Tax Court is a court of record. This means that everything that happens in court will be recorded. The Tax Court contracts with an independent reporting company who records the entire trial. Because the reporter recording the trial is not a Tax Court employee, you should not leave any documents with the reporter. You can obtain more information about the typewritten record of the trial (<a href="/petitioners-after#AFTER7">Transcript</a>) under the section "<a href="/petitioners-after" title="After Trial">After Trial</a>".',
                "anchortag": "DURING10",
            },
        ]

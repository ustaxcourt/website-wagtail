...
# MAY CHANGE THE NAME OF THIS CLASS TO SOMETHING MORE APPROPRIATE
        ...
        new_page = home_page.add_child(
            instance=EnhancedStandardPage(
                ...
                body=[
                    {
                        "type": "h2",
                        "value": "What to expect during the tax court process, what documents you will need, links to forms, and a checklist to use.",
                    },

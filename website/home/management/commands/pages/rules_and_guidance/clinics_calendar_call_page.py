...
""",
            ...
            },
            {
                ...
                "answer": f"""<ul>
                    <li><a href="{docs['2021_calendar_call_program_sample_letter.pdf']}" title="Sample Letter" target="_blank">Letter to Chief Judge (sample): 2021_calendar_call_program_sample_letter.pdf</a><br/></li>
                    </ul>
                """,
                "anchortag": "REFDOCS",
            },

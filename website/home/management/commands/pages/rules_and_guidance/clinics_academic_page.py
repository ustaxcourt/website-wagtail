    ...
    def create_page_info(self, home_page):
        ...
        questions = [
            ...
            },
            {
                ...
                "answer": f"""<ul>
                    <li><a href="{docs['2021_letter_to_CJ_academic_law_and_nonlaw.pdf']}" title="Sample Letter" target="_blank">Letter to Chief Judge (Sample): 2021_letter_to_CJ_academic_law_and_nonlaw.pdf</a><br/></li>
                    <li><a href="{docs['stuffer_notice.pdf']}" title="Format for Stuffer Notice" target="_blank">Format for Stuffer Notice: stuffer_notice.pdf</a></li>
                    </ul>
                """,
                "anchortag": "REFDOCS",
            },

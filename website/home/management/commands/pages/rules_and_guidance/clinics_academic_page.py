    ...
    def create_page_info(self, home_page):
        ...
        questions = [
            ...
            },
            {
                ...
                "answer": f"""<ul>
                    <li><a linktype="document" id="{docs["2021_letter_to_CJ_academic_law_and_nonlaw.pdf"].id}" title="Sample Letter" target="_blank">Letter to Chief Judge (Sample): 2021_letter_to_CJ_academic_law_and_nonlaw.pdf</a><br/></li>
                    <li><a linktype="document" id="{docs["stuffer_notice.pdf"].id}" title="Format for Stuffer Notice" target="_blank">Format for Stuffer Notice: stuffer_notice.pdf</a></li>
                    </ul>
                """,
                "anchortag": "REFDOCS",
            },

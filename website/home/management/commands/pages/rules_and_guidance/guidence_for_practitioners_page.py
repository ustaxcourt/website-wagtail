            ...
            instance=EnhancedStandardPage(
                ...
                body=[
                    ...
                    {"type": "h3", "value": "Admission of Attorneys"},
                    {
                        ...
                        <ul>
                            <li><a linktype="document" id="{practitioners_docs["Application_for_Admission_to_Practice_Attorney_Form_30.pdf"].id}" title="Application for Admission to Practice, Form 30" target="_blank">Application for Admission to Practice, Form 30</a>. For instructions on completing the form, please see <a linktype="document" id="{practitioners_docs["Admissions_Information_Attorney_12212021.pdf"].id}" title="Admissions Information for Attorneys" target="_blank">Admissions Information for Attorneys</a>.</li>
                    ...
                    {
                        "type": "paragraph",
                        "value": f"""On May 29, 2020, the Court issued <a linktype="document" id="{practitioners_docs["Administrative_Order_2020-03.pdf"].id}" title="Administrative Order 2020-03" target="_blank">Administrative Order 2020-03</a> which outlines the procedures for entering a limited entry of appearance. These procedures are effective June 1, 2020.""",
                    },
                    {
                        "type": "links",
                        "value": {

# Generated by Django 5.2.17 on 2026-09-14 13:07
        ...
        migrations.AlterField(
            ...
            field=wagtail.fields.StreamField(
                [
                    ...
                    ("callout", 45),
                    ("grid", 107),
                    ("summary_timeline", 113),
                    ("hero_section", 118),
                    ("printable_section", 122),
                    ("card_tiles", 149),
                    ("quick_access_tiles", 139),
                ],
                blank=True,
                block_lookup={
                    ...
                    93: ("wagtail.blocks.RichTextBlock", (), {"required": True}),
                    94: (
                        "wagtail.blocks.ChoiceBlock",
                        [],
                    ...
                    96: ("wagtail.blocks.ListBlock", (95,), {"label": "Card Set"}),
                    97: (
                        "wagtail.blocks.ChoiceBlock",
                        [],
                        {
                    ...
                    134: ("wagtail.blocks.PageChooserBlock", (), {}),
                    135: ("wagtail.blocks.URLBlock", (), {}),
                    136: (
                        "wagtail.blocks.StreamBlock",
                        [[("related_page", 134), ("external_url", 135)]],
                        {
                    ...
                    149: (
                        ...
                        [
                            [
                                ("tiles", 145),
                                ("default_content", 146),
                                ("show_back_button", 147),
                                ("back_button_text", 148),
                            ]
                        ],
                        {},
                    ),

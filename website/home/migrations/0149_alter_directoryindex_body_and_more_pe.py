        ...
        migrations.AlterField(
            ...
            field=wagtail.fields.StreamField(
                [
                    ...
                    ("hero_section", 127),
                    ("printable_section", 132),
                    ("card_tiles", 159),
                    ("quick_access_tiles", 149),
                ],
                blank=True,
                block_lookup={
                    0: (
                    ...
                    131: (
                        "wagtail.blocks.StreamBlock",
                        [[("heading", 130), ("list", 72), ("paragraph", 10)]],
                        {"required": True},
                    ),
                    132: (
                        "wagtail.blocks.StructBlock",
                        [[("icon", 128), ("title", 25), ("intro", 129), ("body", 131)]],
                        {},
                    ),
                    133: (
                        "home.blocks.SVGDocumentChooserBlock",
                    ...
                    144: ("wagtail.blocks.PageChooserBlock", (), {}),
                    145: ("wagtail.blocks.URLBlock", (), {}),
                    146: (
                        "wagtail.blocks.StreamBlock",
                        [[("related_page", 144), ("external_url", 145)]],
                        {
                    ...
                    159: (
                        ...
                        [
                            [
                                ("tiles", 155),
                                ("default_content", 156),
                                ("show_back_button", 157),
                                ("back_button_text", 158),
                            ]
                        ],
                        {},
                    ),

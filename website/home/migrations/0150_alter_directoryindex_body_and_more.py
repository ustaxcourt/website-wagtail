...
class Migration(migrations.Migration):
    dependencies = [
        ("home", "0149_alter_enhancedstandardpage_body_pe"),
    ]
        ...
        migrations.AlterField(
            ...
            field=wagtail.fields.StreamField(
                [
                    ...
                    ("hero_section", 142),
                    ("printable_section", 146),
                    ("card_tiles", 173),
                    ("quick_access_tiles", 163),
                ],
                blank=True,
                block_lookup={
                    0: (
                    ...
                    158: ("wagtail.blocks.PageChooserBlock", (), {}),
                    159: ("wagtail.blocks.URLBlock", (), {}),
                    160: (
                        "wagtail.blocks.StreamBlock",
                        [[("related_page", 158), ("external_url", 159)]],
                        {
                    ...
                    173: (
                        ...
                        [
                            [
                                ("tiles", 169),
                                ("default_content", 170),
                                ("show_back_button", 171),
                                ("back_button_text", 172),
                            ]
                        ],
                        {},
                    ),

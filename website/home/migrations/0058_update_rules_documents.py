...
def update_document_file(Document, current_title, base_path, source_filename, new_title):
    ...
    try:
        ...
        with open(full_path, 'rb') as f:
            ...
            print(f"  -> Uploading '{source_filename}' to configured storage (e.g., S3)...")
...
def apply_document_updates_from_csv(apps, schema_editor):
    ...
    csv_filename = os.path.basename(__file__).replace('.py', '.csv') # e.g., 0058_rules_document_updates.csv
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.RunPython(apply_document_updates_from_csv, migrations.RunPython.noop),
    ]

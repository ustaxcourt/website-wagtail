        ...
        migrations.AlterField(
            ...
            field=wagtail.fields.StreamField(
                [
                    ...
                    ("detailed_timeline", 126),
                    ("hero_section", 131),
                    ("printable_section", 136),
                    ("card_tiles", 163),
                    ("quick_access_tiles", 153),
                ],
                blank=True,
                block_lookup={
                    0: (
                    ...
                    126: (
                        "wagtail.blocks.StructBlock",
                        [[("title", 123), ("introduction", 124), ("phases", 125)]],
                        {},
                    ),
                    127: (
                        "wagtail.blocks.CharBlock",
                    ...
                    135: (
                        "wagtail.blocks.StreamBlock",
                        [[("heading", 134), ("list", 72), ("paragraph", 10)]],
                        {"required": True},
                    ),
                    136: (
                        "wagtail.blocks.StructBlock",
                        [[("icon", 132), ("title", 25), ("intro", 133), ("body", 135)]],
                        {},
                    ),
                    137: (
                        "home.blocks.SVGDocumentChooserBlock",
                    ...
                    148: ("wagtail.blocks.PageChooserBlock", (), {}),
                    149: ("wagtail.blocks.URLBlock", (), {}),
                    150: (
                        "wagtail.blocks.StreamBlock",
                        [[("related_page", 148), ("external_url", 149)]],
                        {
                    ...
                    163: (
                        ...
                        [
                            [
                                ("tiles", 159),
                                ("default_content", 160),
                                ("show_back_button", 161),
                                ("back_button_text", 162),
                            ]
                        ],
                        {},
                    ),

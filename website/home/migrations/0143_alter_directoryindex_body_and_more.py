# Generated by Django 5.2.17 on 2026-09-16 18:15
        ...
        migrations.AlterField(
            ...
            field=wagtail.fields.StreamField(
                [
                    ...
                    ("hero_section", 121),
                    ("printable_section", 125),
                    ("card_tiles", 152),
                    ("quick_access_tiles", 142),
                ],
                blank=True,
                block_lookup={
                    0: (
                    ...
                    137: ("wagtail.blocks.PageChooserBlock", (), {}),
                    138: ("wagtail.blocks.URLBlock", (), {}),
                    139: (
                        "wagtail.blocks.StreamBlock",
                        [[("related_page", 137), ("external_url", 138)]],
                        {
                    ...
                    152: (
                        ...
                        [
                            [
                                ("tiles", 148),
                                ("default_content", 149),
                                ("show_back_button", 150),
                                ("back_button_text", 151),
                            ]
                        ],
                        {},
                    ),

...
def fix_petitioner_before_page(apps, schema_editor):
    """Fix the petitioner before page by updating it through the proper model"""
    # Get models
...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.RunPython(
            code=fix_petitioner_before_page,
